...
$(function(){
	$("#btnReceive").click(function(){
		document.form1.action="${path}/message/messagereplyview.do";
		document.form1.submit();
	});
	$("#btnUpdate").click(function(){
		if(confirm("삭제하시겠습니까?")){
			document.form1.action="${path}/message/messageupdate.do?idx=${dto.idx}";
			document.form1.submit();
		}
	});
});
...
<br>
 ...
 <ul class="nav nav-tabs nav-justified" style="text-align: center; width:50%; margin:0 auto;" > 
  <li style="background-color: rgb(238,238,238); border-top-left-radius: 10px; " role="presentation"><a href="${path}/message/messagelist.do">받은 메시지</a></li>
  <li style="background-color: white;" role="presentation"><a href="${path}/message/receiverlist.do">보낸 메시지</a></li>
</ul>
...
<input class="btn btn-default" type="button" value="답변" id="btnReceive">
