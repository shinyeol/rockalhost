...
$(function(){
	$("#btnInsert").click(function(){		
		...
		alert("발송완료되었습니다.");
		document.form1.action="${path}/message/messageinsert.do";
...
<table class="table table-hover table-bordered" style="max-width:80%; margin:5 auto; "> 
   ...
   <tr>  
      <td>보낸이</td>      
      <td><input class="form-control" id="sender" name="sender" value="${nickName}" readonly="readonly"></td>
   </tr>
   <tr>
      <td>받는이</td>
      <td><input class="form-control" id="receiver" name="receiver"></td>
   </tr>
   <tr>
      <td>제목</td>
