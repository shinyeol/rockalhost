...
$(function() {
	$("#btnList").click(function(){
		location.href = "${path}/admin/rbList.do";
	});
...
<div class="container-fluid" style="margin-top: 100px;">
	<div class="row row-offcanvas row-offcanvas-right">
		...
		<h2>리뷰게시판 열람<span style="font-size: 17px;"> &lt;총${count}개&gt;</span></h2>
	...
	<tr>
		<td>[${dto.pf_title}]</td>
		<td>
			<a href="${path}/admin/rbView.do?num=${dto.num}&curPage=${page.curPage}&pf_title=${dto.pf_title}">${dto.subject}</a>
		...
		<td>
			<a onclick="return confirm('게시물을 삭제하시겠습니까?')" id="btnDelete" class="btn btn-default"
				href="${path}/admin/rbHidden.do?num=${dto.num}">삭제</a>
...
<table style="width: 930px">
	<tr align="center">
		<td>
		<form name="search_form" method="post" action="${path}/admin/rbList.do">
