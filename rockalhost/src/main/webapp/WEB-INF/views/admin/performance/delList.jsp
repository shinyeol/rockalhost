...
<script>
	$(function() {
		$("#btnList").click(function(){
			location.href="${path}/admin/performance/delList.do";
		});
	});
	
	function list(curPage) {
		location.href="${path}/admin/performance/delList.do?curPage="+curPage;
	}
...
<table style="width: 930px">
	<tr align="center">
		<td>
			<form name="search_form" method="post" action="${path}/admin/performance/delList.do">
