...
<script>
    ...
    $(function(){
    	$("#btnWithdrawal").click(function(){
		    if(confirm("제명하시겠습니까?")){
	    		document.form1.action="${path}/admin/withdrawal.do";
	    		document.form1.submit();
...
<label id="edit_div_label">&nbsp;필수 입력 정보&nbsp;</label><br><br></c:if>
  ...
  <h5>서브 포지션</h5>
    ...
    <label id="edit_div_label">&nbsp;밴드 정보&nbsp;</label><br><br>
   <h5>내 밴드</h5>
...
<input style="width: 100px; float: left;" class="btn" type="button" id="btnWithdrawal" value="탈퇴처리">
<input style="width: 100px;" type="button" class="btn" value="목록" onclick="location.href='${path}/admin/memberList.do'">
