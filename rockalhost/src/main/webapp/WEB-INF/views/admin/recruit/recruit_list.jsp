...
<script>
	function list(page) {
		location.href = "${path}/admin/recruit_list.do?curPage=" + page;
	}
</script>
</head>
<body>
...
<div class="container" style="width: 1300px">
	...
	<table  class="table table-hover table-bordered">
		...
		<c:forEach var="dto" items="${map.list}">
			...
			<tr>
				<td>${dto.idx}</td>
				<td>
				<a href="${path}/admin/recruit_view/${dto.idx}">${dto.subject}</a>
					<c:if test="${dto.cnt > 0}">
	...
	<form name="form1" method="post" action="${path}/admin/recruit_list.do">
