...
$(function() {
	$("#btnList").click(function(){
		location.href = "${path}/admin/boardDelList.do";
	});
});

function list(curPage) {
	location.href="${path}/admin/boardDelList.do?curPage="+curPage
...
<table style="width: 930px">
	<tr align="center">
		<td>
		<form name="search_form" method="post" action="${path}/admin/boardDelList.do">
